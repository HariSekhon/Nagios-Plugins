...
- ```check_redis_*``` - check Redis API writes/reads/deletes with timings, replication, replicated writes, connected clients, gather statistics, alert on any single stat
