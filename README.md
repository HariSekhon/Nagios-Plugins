...
- ```check_selenium_hub_browser.py``` - checks Selenium Grid Hub / Selenoid by requesting a browser (eg. chrome or firefox), querying a url and optionally performing a content or regex match on the resulting web page
