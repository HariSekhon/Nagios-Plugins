...
- ```check_atlas_*``` - Apache Atlas status and entity checks including entity existence, state=ACTIVE, expected type, expected tags and traits are assigned to entity
