...
- ```check_dns.pl``` - more advanced DNS query checker including NS records for your public domain name, MX records for your mail servers, SOA, SRV, TXT as well as A and PTR records
