...
- ```check_ibm_biginsights_*.pl``` - IBM BigInsights Hadoop distribution checks including services, nodes, agents, BigSheets workbook runs, dfs paths and properties, HDFS space and block replication, BI console version
