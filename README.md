...
- ```check_elasticsearch_*.pl``` - checks Elasticsearch cluster state / shards / replicas, nodes / data nodes, index existence / shards / replicas / settings, single node online and elasticsearch / lucene versions
