...
- ```check_selenium_hub_browser.py``` - checks [Selenium Grid](https://www.selenium.dev/documentation/en/grid/) Hub / [Selenoid](https://aerokube.com/selenoid/) by requesting a browser (eg. chrome or firefox), querying a url and optionally performing a content or regex match on the returned web page
