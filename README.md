...
- ```check_hadoop_*.pl``` - various Hadoop monitoring utilities for HDFS & MapReduce including cluster balance, replication, space, block count limits, dead Datanodes and TaskTrackers, blacklisted TaskTrackers, Namenode, JobTracker & Yarn Resource Manager heap usage, gather metrics
