...
[![DockerHub](https://img.shields.io/badge/docker%20container-available-blue.svg)](https://hub.docker.com/r/harisekhon/nagios-plugins/)
...
Don't copy plugins out as most require the co-located libraries I've written so you should git clone && make each time - it's much simpler.
