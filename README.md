...
- ```check_couchdb_*.py``` - [Apache CouchDB](http://couchdb.apache.org/) API checks including server status, databases exists, doc counts, data size, compaction running, version
