...
- ```check_elasticsearch_*.pl``` - checks Elasticsearch cluster state / shards / replicas, nodes / data nodes, index existence / shards / replicas / siettings / age / stats, master node, specific node online, elasticsearch / lucene versions
