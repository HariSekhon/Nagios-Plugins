...
- ```check_elasticsearch_*.pl``` - checks Elasticsearch cluster state / shards / replicas, nodes / data nodes, index existence / shards / replicas / settings / age / stats, master node, node stats, specific node online, elasticsearch / lucene versions
