...
class CheckZaloniBedrockIngestion(NagiosPlugin):
    ...
    def check_ingestion(self, num, filter_opts=None, max_age=None, max_runtime=None):
        ...
        try:
            ...
            longest_incomplete_age_timedelta = self.check_longest_incomplete_ingest(result, max_runtime)
            # newest is first
            ...
            self.msg += ' longest_incomplete_ingest_age={0}s;{1}'.format(longest_incomplete_age_timedelta.seconds \
                                                                         if longest_incomplete_age_timedelta else 0,
